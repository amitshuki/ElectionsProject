...
public:
	...
	void addDistrict(const myString& districtName, const int& rank, const DistrictType& dt);
	void addCitizen(const myString& name, const int& id, const int& birthYear, const int& districtSN);
